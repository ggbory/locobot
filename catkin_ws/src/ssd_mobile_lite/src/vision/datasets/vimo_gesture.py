...
class vimo_gestureDataset:
    ...
    def __init__(self, root, transform=None, target_transform=None, is_test=False, keep_difficult=False, label_file=None):
        ...
        self.ids = vimo_gestureDataset._read_image_ids(image_sets_file)
        ...
        if os.path.isfile(label_file_name):
            ...
            logging.info("vimo gesture Labels read from file: " + str(self.class_names))

        else:
            logging.info("No labels file, using default VOC classes.")
            self.class_names = ('BACKGROUND', 'person', 'palm', 'finger_one', 'finger_two', 'finger_three')
